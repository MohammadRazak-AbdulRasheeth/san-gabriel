...
const ApproachSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-r from-primary-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
          {approachSteps.map((step, index) => (
            <motion.div 
              ...
              viewport={{ once: true }} 
              className="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-neutral-100 hover:shadow-xl transition-shadow duration-300"
            >
              <div className="w-10 h-10 md:w-12 md:h-12 bg-accent-100 rounded-full flex items-center justify-center mb-4 md:mb-6">
                <span className="text-lg md:text-xl font-bold text-accent-600">{index + 1}</span>
              </div>
              <h3 className="text-lg md:text-xl font-bold text-primary-900 mb-3 md:mb-4">{step.title}</h3>
        ...
        <motion.div 
          ...
          viewport={{ once: true }} 
          className="bg-white rounded-2xl p-6 md:p-8 lg:p-12 shadow-lg border border-neutral-100"
        >
          <h3 className="text-xl md:text-2xl font-bold text-primary-900 mb-6 text-center">
            What Sets Our Approach Apart
          </h3>
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <div>
              <h4 className="text-base md:text-lg font-bold text-primary-900 mb-2 md:mb-3">Integrated Marketing & Advertising</h4>
            ...
            <div>
              <h4 className="text-base md:text-lg font-bold text-primary-900 mb-2 md:mb-3">Business-Aligned Execution</h4>
              <p className="text-sm md:text-base text-neutral-600 leading-relaxed">
            ...
            <div>
              <h4 className="text-base md:text-lg font-bold text-primary-900 mb-2 md:mb-3">Continuous Improvement</h4>
              <p className="text-sm md:text-base text-neutral-600 leading-relaxed">
            ...
            <div>
              <h4 className="text-base md:text-lg font-bold text-primary-900 mb-2 md:mb-3">Transparent Reporting</h4>
              <p className="text-sm md:text-base text-neutral-600 leading-relaxed">
