    ...
    <>
      ...
      <section className="py-20 bg-primary-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {whoWeWorkWith.map((client, index) => (
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }} 
                viewport={{ once: true }} 
                className="bg-primary-800 rounded-xl p-8 border border-primary-700 hover:border-accent-500 transition-colors duration-300"
              >
          ...
          >
            <div className="bg-primary-800 rounded-2xl p-8 md:p-12 inline-block">
              <h3 className="text-2xl font-bold mb-4">Partners, Not Vendors</h3>
